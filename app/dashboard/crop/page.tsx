    ...
    <div className="min-h-screen bg-plant-gradient">
      <div className="mx-auto max-w-5xl px-4 py-8 space-y-6">
        <div className="rounded-2xl bg-card border border-border shadow-plant p-6 flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-semibold">Crop Health</h1>
            <p className="text-sm text-foreground/70">Overview and guidance for crop vitality</p>
          </div>
          <Link href="/dashboard">
        ...
        <div className="rounded-2xl bg-card border border-border shadow-plant p-6">
          <p className="text-sm text-foreground/70">This section will host crop health insights and recommendations.</p>
        </div>
      </div>
    </div>
  )
